...
# NOTES FROM Pycharm - Python Anywhere
# Downgrading selenium from
# s = Service("C:/Users/Owen/Documents/Personal Info/Independent Courses/Python Learning/chromedriver")
# TO
#     driver = webdriver.Chrome("C:/Users/Owen/Documents/Personal Info/Independent Courses/Python Learning/chromedriver")
...
def get_mge_wholesale_data():
    ...
    # TODO 0: Current Status: gets all data and writes to CSV in local folder
    # TODO: May need a timeout exception if it gets stuck
    ...
    driver = webdriver.Chrome(executable_path=r"C:/Users/Owen/Documents/Personal Info/Independent Courses/Python Learning/chromedriver")

    # END PYTHON ANYWHERE CODE
